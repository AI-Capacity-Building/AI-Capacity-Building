...
# dataframe1 = pd.read_csv("accidents_usecase\Accidents.txt") 
  
# # storing this dataframe in a csv file 
# dataframe1.to_csv('accidents_usecase\Accidents19May.csv', index = None) 

train_df = pd.read_csv('Accidents19May.csv')
...
# Plot the heatmap
sns.heatmap(corrmat, annot=True, linewidths=1, linecolor='k', square=True, mask=False, vmin=-1, vmax=1, cbar_kws={"orientation": "vertical"}, cbar=True, ax=ax)
...
dtrain = xgb.DMatrix(train_col, train_y, feature_names=list(train_col.columns))
